    ...
    <div className="nav_about">
      ...
      <div className={darkTheme ? "contact-content dark-theme" : "contact-content"}>
        ...
        <main>
          ...
          <span className="contact-about-me">
            ...
            MySQL, ReactJS, and MongoDB. Each new project fuels my excitement for technology and drives me to
            continuously expand my expertise.
          </span>
          <span className="contact-about-me">
            I am always looking for new ways to improve my skills and knowledge. I am excited to see what the future
            holds for me in the field of software engineering.
          </span>
