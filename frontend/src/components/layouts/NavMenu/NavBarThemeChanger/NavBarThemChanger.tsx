...
import './NavBarThemChanger.css'
import {useTheme} from "../../../../context/ThemeContext";
import {toast} from "sonner";


export const NavBarThemChanger = () => {
    ...
    return (<label className="switch">
        <span className={"moon"}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path
        ...
        <span className="sun"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill="#ffd43b"><circle
        ...
        <input type="checkbox" className="input" onChange={handleDarkThemeUse} checked={darkTheme}/>
