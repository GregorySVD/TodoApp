    ...
    <div className="nav_about">
      ...
      <div className={darkTheme ? "about-content dark-theme" : "about-content"}>
        ...
        <h2 className="about-content-header">
          <i className="fa fa-check"></i> TodoApp - MegaK Final Project
        </h2>
        <p className="about-content-description">
          TodoApp is a simple task manager written as a final project for the MegaK course. The application allows users
          to add, delete, edit, and mark tasks as completed.
        </p>
        ...
        <ul className="about-content-features_list">
          ...
          <li>
            Toast notification: Users receive real-time feedback and updates about their actions, enhancing the
